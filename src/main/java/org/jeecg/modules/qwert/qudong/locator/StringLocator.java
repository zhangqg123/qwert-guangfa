...
import org.jeecg.modules.qwert.qudong.exception.IllegalDataTypeException;
...
public class StringLocator extends BaseLocator<String> {
    ...
    //        StringLocator l1 = new StringLocator(1, RegisterRange.DIANZONG_REGISTER, 0, DataType.CHAR, 4);
    //        StringLocator l2 = new StringLocator(1, RegisterRange.DIANZONG_REGISTER, 0, DataType.VARCHAR, 4);
    //
    //        short[] s;
    //
