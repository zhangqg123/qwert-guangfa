 ...
 */
package org.jeecg.modules.qwert.qudong;
...
import org.jeecg.modules.qwert.qudong.base.KeyedModbusLocator;
import org.jeecg.modules.qwert.qudong.base.ReadFunctionGroup;
import org.jeecg.modules.qwert.qudong.base.SlaveProfile;
...
import org.jeecg.modules.qwert.qudong.exception.ErrorResponseException;
import org.jeecg.modules.qwert.qudong.exception.ModbusInitException;
import org.jeecg.modules.qwert.qudong.locator.BaseLocator;
import org.jeecg.modules.qwert.qudong.msg.QwertRequest;
import org.jeecg.modules.qwert.qudong.msg.QwertResponse;
import org.jeecg.modules.qwert.qudong.msg.ReadDianzongRequest;
import org.jeecg.modules.qwert.qudong.msg.ReadResponse;
import org.jeecg.modules.qwert.qudong.sero.epoll.InputStreamEPollWrapper;
import org.jeecg.modules.qwert.qudong.sero.log.BaseIOLog;
import org.jeecg.modules.qwert.qudong.sero.messaging.MessageControl;
import org.jeecg.modules.qwert.qudong.sero.util.ArrayUtils;
import org.jeecg.modules.qwert.qudong.sero.util.ProgressiveTask;
...
abstract public class QwertMaster extends Qwert {
     ...
     * <p>init.</p>
     *
     * @throws org.jeecg.modules.qwert.qudong.exception.ModbusInitException if any.
     */
     ...
     * <p>send.</p>
     *
     * @param request a {@link org.jeecg.modules.qwert.qudong.msg.QwertRequest} object.
     ...
     */
    public final QwertResponse send(QwertRequest request) throws QudongTransportException {
//        request.validate(this);
     ...
     * @throws org.jeecg.modules.qwert.qudong.exception.QudongTransportException if any.
     */
    abstract public QwertResponse sendImpl(QwertRequest request) throws QudongTransportException;
     ...
     * @throws org.jeecg.modules.qwert.qudong.exception.QudongTransportException
     *             if there was an IO error or other technical failure while sending the message
     * @throws org.jeecg.modules.qwert.qudong.exception.ErrorResponseException
     *             if the response returned from the slave was an exception.
     * @param <T> a T object.
     */
    @SuppressWarnings("unchecked")
    public <T> T getValue(BaseLocator<T> locator) throws QudongTransportException, ErrorResponseException {
     ...
     * @return a {@link org.jeecg.modules.qwert.qudong.sero.util.ProgressiveTask} object.
     */
 ...
 //           send(new ReadInputRegistersRequest(node, 0, 4));
     ...
     *
     * @return a {@link org.jeecg.modules.qwert.qudong.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @param ioLog a {@link org.jeecg.modules.qwert.qudong.sero.log.BaseIOLog} object.
     */
     ...
     *
     * @return a {@link org.jeecg.modules.qwert.qudong.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     *
     * @param ePoll a {@link org.jeecg.modules.qwert.qudong.sero.epoll.InputStreamEPollWrapper} object.
     */
     ...
     * @throws org.jeecg.modules.qwert.qudong.exception.QudongTransportException if any.
     * @throws org.jeecg.modules.qwert.qudong.exception.ErrorResponseException if any.
     * @param <K> type of result
     */
    public <K> BatchResults<K> send(BatchRead<K> batch) throws QudongTransportException, ErrorResponseException {
        if (!initialized)
            throw new QudongTransportException("not initialized");
     ...
     *
     * @return a {@link org.jeecg.modules.qwert.qudong.sero.messaging.MessageControl} object.
     */
     ...
     *
     * @param conn a {@link org.jeecg.modules.qwert.qudong.sero.messaging.MessageControl} object.
     */
    ...
    private <K> void sendFunctionGroup(ReadFunctionGroup<K> functionGroup, BatchResults<K> results,
            boolean errorsInResults, boolean exceptionsInResults) throws QudongTransportException,
 ...
 //           request = new ReadInputRegistersRequest(slaveId, startOffset, length);
    ...
    private void setValue(QwertRequest request) throws QudongTransportException, ErrorResponseException {
