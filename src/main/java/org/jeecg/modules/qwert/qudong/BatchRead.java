...
import org.jeecg.modules.qwert.qudong.base.SlaveAndRange;
...
public class BatchRead<K> {
    ...
    /**
     * A batch may be split into an arbitrary number of individual Qwert requests, and so a given batch may take
     ...
     *
     * @param master a {@link QwertMaster} object.
     * @return a {@link java.util.List} object.
     */
    public List<ReadFunctionGroup<K>> getReadFunctionGroups(QwertMaster master) {
    ...
    // Private stuff
    //
    private void doPartition(QwertMaster master) {
