...
public class VoiceUtils {
	 ...
	 * @param txt
	 */
	public static void textToSpeech(String text,String vn) {
...
*/
	...
	//		Dispatch.put(spAudioFormat, "Type", new Variant(22));
			Dispatch.put(spAudioFormat, "Type", new Variant(4));
			// 设置文件输出流格式
			Dispatch.putRef(spFileStream, "Format", spAudioFormat);
			// 调用输出 文件流打开方法，创建一个.wav文件
//			Dispatch.call(spFileStream, "Open", new Variant("./text.mp3"), new Variant(3), new Variant(true));
			Dispatch.call(spFileStream, "Open", new Variant("./voice/"+vn+".wav"), new Variant(3), new Variant(true));
			// 设置声音对象的音频输出流为输出文件对象
