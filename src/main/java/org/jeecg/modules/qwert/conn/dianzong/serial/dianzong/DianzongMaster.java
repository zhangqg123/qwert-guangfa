...
import org.jeecg.modules.qwert.conn.dianzong.serial.SerialMaster;
import org.jeecg.modules.qwert.conn.dianzong.serial.SerialPortWrapper;
import org.jeecg.modules.qwert.conn.dianzong.serial.SerialWaitingRoomKeyFactory;
import org.jeecg.modules.qwert.conn.dianzong.sero.messaging.MessageControl;
import org.jeecg.modules.qwert.conn.dianzong.sero.messaging.StreamTransport;

/**
 * <p>DianzongMaster class.</p>
 *
 * @author Matthew Lohbihler
 * @version 5.0.0
 */
public class DianzongMaster extends SerialMaster {
    ...
    /**
     * <p>Constructor for DianzongMaster.</p>
     *
    ...
    /** {@inheritDoc} */
    @Override
    public QwertResponse sendImpl(QwertRequest request) throws DianzongTransportException {
        ...
        try {
            ...
            try {
                ...
                throw new DianzongTransportException(e2, request.getSlaveId());
            }
        }
    }
}
