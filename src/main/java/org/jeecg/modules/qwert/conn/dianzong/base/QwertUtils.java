 ...
 */
package org.jeecg.modules.qwert.conn.dianzong.base;

import org.jeecg.modules.qwert.conn.dianzong.code.RegisterRange;
import org.jeecg.modules.qwert.conn.dianzong.exception.IllegalSlaveIdException;
...
public class QwertUtils {
     ...
     */
    public static void validateOffset(int offset) throws DianzongTransportException {
        if (offset < 0 || offset > 65535)
            throw new DianzongTransportException("Invalid offset: " + offset);
    }
     ...
     * @throws org.jeecg.modules.qwert.conn.dianzong.exception.DianzongTransportException if any.
     */
    public static void validateEndOffset(int offset) throws DianzongTransportException {
        if (offset > 65535)
            throw new DianzongTransportException("Invalid end offset: " + offset);
    }
     ...
     * @throws org.jeecg.modules.qwert.conn.dianzong.exception.DianzongTransportException if any.
     */
    public static void checkCRC(QwertMessage QwertMessage, ByteQueue queue) throws DianzongTransportException {
        // Check the CRC
        int calcCrc = calculateCRC(QwertMessage);
        int givenCrc = QwertUtils.popUnsignedShort(queue);

        if (calcCrc != givenCrc)
            throw new DianzongTransportException("CRC mismatch: given=" + givenCrc + ", calc=" + calcCrc,
