...
/**
 * <p>Abstract QwertMessage class.</p>
 *
 * @author Matthew Lohbihler
 * @version 5.0.0
 */
abstract public class QwertMessage {
	protected int simulator=0;
    protected int slaveId;

    public QwertMessage(int slaveId) throws QudongTransportException {
        // Validate the node id. Note that a 0 slave id is a broadcast message.
        if (slaveId < 0 /* || slaveId > 247 */)
            throw new QudongTransportException("Invalid slave id", slaveId);
...
//    abstract public byte[] getRetData();
     ...
     * @throws Exception 
     */
    final public void write2(ByteQueue queue,int r) {
//        StringBuilder qs=new StringBuilder();
//    	String[] tmp = (""+this.getVer()).split("\\.");
...
//        QwertUtils.pushByte(queue, slaveId);
     ...
     * <p>writeImpl.</p>
     *
     * @param qs a {@link org.jeecg.modules.qwert.conn.qudong.sero.util.queue.ByteQueue} object.
     */
//    abstract protected void writeImpl2(StringBuilder qs);
