...
import org.jeecg.modules.qwert.conn.dianzong.sero.messaging.DefaultMessagingExceptionHandler;
import org.jeecg.modules.qwert.conn.dianzong.sero.messaging.MessagingExceptionHandler;
...
public class Qwert {
     ...
     */
    public void validateNumberOfBits(int bits) throws DianzongTransportException {
        if (bits < 1 || bits > maxReadBitCount)
            throw new DianzongTransportException("Invalid number of bits: " + bits);
    }
     ...
     * @throws org.jeecg.modules.qwert.conn.dianzong.exception.DianzongTransportException if any.
     */
    public void validateNumberOfRegisters(int registers) throws DianzongTransportException {
        if (registers < 1 || registers > maxReadRegisterCount)
            throw new DianzongTransportException("Invalid number of registers: " + registers);
    }
     ...
     *
     * @return a {@link org.jeecg.modules.qwert.conn.dianzong.sero.messaging.MessagingExceptionHandler} object.
     */
