...
import org.jeecg.modules.qwert.conn.dianzong.sero.messaging.RequestHandler;
...
abstract public class BaseRequestHandler implements RequestHandler {
     ...
     */
    protected QwertResponse handleRequestImpl(QwertRequest request) throws DianzongTransportException {
