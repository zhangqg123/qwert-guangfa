...
abstract public class ReadBinaryRequest extends QwertRequest {
     ...
     */
    public ReadBinaryRequest(int slaveId, int startOffset, int numberOfBits) throws DianzongTransportException {
        super(slaveId);
    ...
    ReadBinaryRequest(int slaveId) throws DianzongTransportException {
        super(slaveId);
    }
     ...
     * @throws org.jeecg.modules.qwert.conn.dianzong.exception.DianzongTransportException if any.
     */
    abstract protected boolean getBinary(ProcessImage processImage, int index) throws DianzongTransportException;
