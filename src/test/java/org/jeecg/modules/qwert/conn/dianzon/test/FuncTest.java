...
public class FuncTest {
	public static int calculateCRC(byte[] b) {
...
/*		byte[] b = new byte[6];
		...
		b[4] = 0;
		b[5] = 3;
		int rc = calculateCRC(b);
		System.out.println(rc);
		String hex = Integer.toHexString(rc);*/
		byte[] data = hexToByteArray("414570a4");
		int offset = 0;
        float ret = Float.intBitsToFloat(((data[offset] & 0xff) << 24) | ((data[offset + 1] & 0xff) << 16)
